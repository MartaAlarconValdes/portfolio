...
export const softSkills = [
  "Trabajo en equipo", "Adaptabilidad", "Comunicación efectiva", "Proactividad", "Organización", "Capacidad de aprendizaje", "Escucha activa", "Creatividad", "Gestión del tiempo"
]
